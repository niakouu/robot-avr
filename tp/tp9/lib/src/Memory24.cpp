...
/******************************************************************************/
Memory24::Memory24() : peripheral_address_(PERIPHERAL_ADDRESS) {
    init();
}

/******************************************************************************/
/* void Memory24::init(void)                                             */
/*                                                                            */
...
/******************************************************************************/
/* uint8_t Memory24::choose_memory_bank(const uint8_t banc)               */
/*                                                                            */
...
/******************************************************************************/
uint8_t Memory24::choose_memory_bank(const Bank bank) {
...
/*                                                                            */
/******************************************************************************/
uint8_t Memory24::read(const uint16_t address) const {
    ...
    TWDR = (address >> UINT8_WIDTH); // 8 bits de poids fort de l'addresse
    TWCR = _BV(TWINT) | _BV(TWEN);   // R. a Z., interrupt. - Depart de transm.
    while ((TWCR & _BV(TWINT)) == 0) // Attente de fin de transmission
        ;
