...
private:
    ...
    static const constexpr float SWEEP_SPEED = 1.0F;

    uint16_t rotateTimeLeftMs_;
    uint8_t counter_, totalReadings_, minimumPoleDistance_;
    ...
    bool isDone_ : 1;
    uint16_t sweepTimeLeft_, flashTimeLeft_;
